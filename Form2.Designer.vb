...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label6.Text = "Already have an account? Click Sign In" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10)
        '
        'Label7
        '
